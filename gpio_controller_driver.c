    ...
    if (gpio_controller_dev) {
        ...
        if (input_register_device(gpio_controller_dev) == 0) {
            if (gpio_is_valid(LEFT_SHOULDER_PIN) == true) {
                if (gpio_request(LEFT_SHOULDER_PIN, sprintf("GPIO_%i", LEFT_SHOULDER_PIN)) == 0) {
            ...
            if (gpio_is_valid(RIGHT_SHOULDER_PIN) == true) {
                if (gpio_request(RIGHT_SHOULDER_PIN, sprintf("GPIO_%i", RIGHT_SHOULDER_PIN)) == 0) {
            ...
            if (gpio_is_valid(START_PIN) == true) {
                if (gpio_request(START_PIN, sprintf("GPIO_%i", START_PIN)) == 0) {
            ...
            if (gpio_is_valid(SELECT_PIN) == true) {
                if (gpio_request(SELECT_PIN, sprintf("GPIO_%i", SELECT_PIN)) == 0) {
            ...
            if (gpio_is_valid(A_PIN) == true) {
                if (gpio_request(A_PIN, sprintf("GPIO_%i", A_PIN)) == 0) {
            ...
            if (gpio_is_valid(B_PIN) == true) {
                if (gpio_request(B_PIN, sprintf("GPIO_%i", B_PIN)) == 0) {
            ...
            if (gpio_is_valid(X_PIN) == true) {
                if (gpio_request(X_PIN, sprintf("GPIO_%i", X_PIN)) == 0) {
            ...
            if (gpio_is_valid(Y_PIN) == true) {
                if (gpio_request(Y_PIN, sprintf("GPIO_%i", Y_PIN)) == 0) {
